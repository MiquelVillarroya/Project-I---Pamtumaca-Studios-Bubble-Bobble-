...
enum class Tile {
	...
	// top >= 200
	TOP_LVL1 = 201, TOP_LVL2 = 202, TOP_LVL3 = 203, TOP_LVL4 = 204,
...
public:
	...
	bool TestCollisionAbovePlatLeft(const AABB& box) const;
	bool TestCollisionAbovePlatRight(const AABB& box) const;
...
private:
	...
	bool IsTileTop(Tile tile) const;
